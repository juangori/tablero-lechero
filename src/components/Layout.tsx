...
const NAV = [
  ...
  { to: '/carga', label: 'Carga semanal', icon: ClipboardPen },
  { to: '/presupuesto', label: 'Presupuesto', icon: Target },
  { to: '/indicadores', label: 'Indicadores', icon: SlidersHorizontal },
  { to: '/datos', label: 'Importar / Exportar', icon: FileSpreadsheet },
]
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-campo-800 text-white">
        <div className="flex items-center gap-3 px-5 h-16 border-b border-white/10">
          ...
          <div className="leading-tight">
            <div className="font-extrabold">Tablero Lechero</div>
            <div className="text-[11px] text-white/60">Campo Norte</div>
          </div>
        </div>
        ...
        <header className="sticky top-0 z-30 bg-campo-700 text-white shadow-sm">
          <div className="flex items-center justify-between gap-3 px-4 md:px-8 h-16">
            <div className="md:hidden flex items-center gap-2">
              <Milk size={22} />
              <span className="font-extrabold">Tablero</span>
            </div>
